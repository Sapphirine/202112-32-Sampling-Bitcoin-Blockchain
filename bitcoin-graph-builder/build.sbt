...
name := "bitcoin-graph-builder"
organization := "edu.columbia.eecs6893"
version := "1.0"
...
libraryDependencies += "org.apache.spark" %% "spark-graphx" % "3.1.2" % "provided"
libraryDependencies += "org.apache.spark" %% "spark-sql" % "3.1.2" % "provided"

// Add bitcoin parsing library
